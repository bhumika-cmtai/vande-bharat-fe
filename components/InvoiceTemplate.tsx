...
export const InvoiceTemplate = ({ order, forwardedRef }: InvoiceTemplateProps) => {
  ...
  const companyDetails = {
    ...
    email: 'support@VandeBharat.com',
    website: 'www.VandeBharat.org',
    logo: '/VandeBharat' // Make sure this logo exists in your /public folder
  };
  ...
  return (
    ...
    <div className="absolute -left-[9999px] top-0 w-[800px] bg-white p-4 font-sans" ref={forwardedRef}>
        ...
        <div className="flex items-center justify-between bg-purple-800 text-white p-8">
            <div className="w-48">
                <Image src={companyDetails.logo} alt="VandeBharat Logo" width={160} height={45} className="brightness-0 invert"/>
            </div>
