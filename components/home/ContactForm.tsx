            ...
            <div className="grid md:grid-cols-2 items-center">
                ...
                <div className="relative h-80 md:h-full w-full min-h-[400px]">
                    ...
                    <div className="absolute bottom-0 left-0 p-8 text-white">
                        <div className="flex items-center gap-3 mb-4"><Mail size={20} /><span>info@vandebharatmart.com</span></div>
                        <div className="flex items-center gap-3 mb-4"><Phone size={20} /><span>+91 1141671550</span></div>
